...
"设置tab缩进
set smartindent
"不在单词中间断行，假设该行文字很长，会尽量不从一个单词中间分割开
set lbr
"打开断行模块对亚洲语言支持m表示允许在两个汉字之间断行即使汉字之间没有出现空格B 表示将两行合并为一行的时候汉字与汉字之间不要补空格
set fo+=mB
"显示括号匹配情况
set sm
...
"        call setline(1,"<head><meta charset=\"UTF-8\"></head>")
		...
		call append(line(".")+1, "	> Author: zhouchang") 
		call append(line(".")+2, "	> Mail: 1165372212@qq.com") 
